...
Data visualisation was used here to initially explore the use of the
four main groups of chemicals("FUNGICIDE", "HERBICIDE", "INSECTICIDE",
"OTHER") in different states in different years:
...
assign this calculated mean value to "(D)", "(NA)" and "(Z)". (Thanks
for Aidan's inspiration!!! He's an angel and a genius!!!)
